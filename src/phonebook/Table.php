...
class Table
{
    ...
    private static $tableHeadColumns = [
        ['title' => 'Должность',        'width' => '25%',],
        ['title' => 'ФИО',              'width' => '29%',],
        ['title' => 'Внутр. #',         'width' => '8%',],
        ['title' => 'Прямой #',         'width' => '9%',],
        ['title' => 'Email',            'width' => '17%',],
        ['title' => 'Расположение',     'width' => '12%',],
    ];
    ...
    private static function getPost(array $entry): string
    {
        ...
        return '<td>' . Helper::normalizeString((string) $content) . '</td>';
    }
    ...
    private static function getInternalPhoneNumber(array $entry): string
    {
        ...
        //    $phoneNumber
        //);
        return '<td class="internal-phone-number">' . $phoneNumber . '</td>';
    }
    ...
    {
        $phoneNumber = $entry['direct_phone_number']
            ? self::formatPhoneNumber($entry['direct_phone_number'])
            : '';
    ...
    {
        return '<td class="email-link text-center">' . $entry['email'] . '</td>';
    }
    ...
    {
        return '<td class="location text-center">' . $entry['location'] . '</td>';
    }
}
